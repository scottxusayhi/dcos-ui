...
describe("ConnectionQueue", () => {
  describe("#init", () => {
    ...
    it("has correct size after initialization (head)", () => {
  ...
  describe("#enqueue", () => {
    ...
    it("sorts connections by priority", () => {
      ...
      expect(queue.head()).toEqual(connection1);
    });
  });

  describe("#dequeue", () => {
    describe("with existing connection", function() {
      it("dequeues correctly (head)", () => {
        const connection = new Connection("asd");
        const queue = new ConnectionQueue()
          .enqueue(connection)
          .dequeue(connection);
