import { CLOSE, OPEN, ABORT, ERROR, SUCCESS } from "../EventTypes";
import { INIT, DONE, STARTED } from "../StateConstants";
...
describe("XHRConnection", () => {
  ...
  describe("state", () => {
    ...
    it("sets correct state on open", () => {
      ...
      expect(req.state).toEqual(STARTED);
    });
